...
These request data objects are all backed by the same nested callable data primitive. If you want the lower-level behavior behind `req.query`, `req.post`, and `req.data`, see [Nest](./Nest.md) and [Data Surfaces](../concepts/data-surfaces.md).
